...
unsigned long main_thread(void*)
{
	...
	const auto player_marker_component = player_marker_xref_sig + *reinterpret_cast<int32_t*>(player_marker_xref_sig + 3
	) + 7;
	...
	const auto game_manager = *reinterpret_cast<game_manager_t**>(game_manager_sig + *reinterpret_cast<int32_t*>(
		game_manager_sig + 3) + 7);
	...
	const auto state_manager = *reinterpret_cast<game_state_t**>(state_manager_sig + *reinterpret_cast<int32_t*>(
		state_manager_sig + 3) + 7);
